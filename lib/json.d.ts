...
export declare function complexColInUri(value: number[] | Uint8Array, index: number, metadata: Edm.Edmx): Lexer.Token;
export declare function complexInUri(value: number[] | Uint8Array, index: number, metadata: Edm.Edmx): Lexer.Token;
export declare function collectionPropertyInUri(value: number[] | Uint8Array, index: number, metadata: Edm.Edmx): Lexer.Token;
export declare function primitiveColInUri(value: number[] | Uint8Array, index: number): Lexer.Token;
export declare function complexPropertyInUri(value: number[] | Uint8Array, index: number, metadata: Edm.Edmx): Lexer.Token;
export declare function annotationInUri(value: number[] | Uint8Array, index: number, metadata: Edm.Edmx): Lexer.Token;
...
export declare function rootExprCol(value: number[] | Uint8Array, index: number, metadata: Edm.Edmx): Lexer.Token;
...
export declare function arrayOrObject(value: number[] | Uint8Array, index: number, metadata: Edm.Edmx): Lexer.Token;
