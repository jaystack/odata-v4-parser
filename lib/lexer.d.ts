...
export declare function tokenize(value: Array<number>, index: number, next: number, tokenValue: any, tokenType: TokenType): Token;
...
export declare function OWS(value: Array<number>, index: number): number;
export declare function RWS(value: Array<number>, index: number): number;
export declare function BWS(value: Array<number>, index: number): number;
...
export declare function pctEncoded(value: Array<number>, index: number): number;
export declare function pctEncodedNoSQUOTE(value: Array<number>, index: number): number;
export declare function pchar(value: Array<number>, index: number): number;
export declare function pcharNoSQUOTE(value: Array<number>, index: number): number;
export declare function base64char(value: number): boolean;
export declare function base64b16(value: Array<number>, index: number): number;
export declare function base64b8(value: Array<number>, index: number): number;
export declare function nanInfinity(value: Array<number>, index: number): number;
export declare function oneToNine(value: number): boolean;
export declare function zeroToFiftyNine(value: Array<number>, index: number): number;
export declare function year(value: Array<number>, index: number): number;
export declare function month(value: Array<number>, index: number): number;
export declare function day(value: Array<number>, index: number): number;
export declare function hour(value: Array<number>, index: number): number;
export declare function minute(value: Array<number>, index: number): number;
export declare function second(value: Array<number>, index: number): number;
export declare function fractionalSeconds(value: Array<number>, index: number): number;
export declare function geographyPrefix(value: Array<number>, index: number): number;
export declare function geometryPrefix(value: Array<number>, index: number): number;
