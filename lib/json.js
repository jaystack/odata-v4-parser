...
function complexColInUri(value, index, metadata) {
...
function complexInUri(value, index, metadata) {
...
function collectionPropertyInUri(value, index, metadata) {
...
function complexPropertyInUri(value, index, metadata) {
    var mark = Lexer.quotationMark(value, index);
    if (mark == index)
        return;
    var start = index;
...
function annotationInUri(value, index, metadata) {
    var mark = Lexer.quotationMark(value, index);
    if (mark == index)
        return;
    var start = index;
...
function rootExprCol(value, index, metadata) {
    var begin = Lexer.beginArray(value, index);
    if (begin == index)
        return;
    var start = index;
...
function arrayOrObject(value, index, metadata) {
