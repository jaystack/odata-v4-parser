...
export namespace ResourcePath {
  export function resourcePath(
    ...
    const token =
      ResourcePath.batch(value, index) ||
    ...
    switch (resource.type) {
      ...
      case Lexer.TokenType.EntityCollectionFunctionImportCall:
        navigation = ResourcePath.collectionNavigation(
          value,
          resource.next,
      ...
      case Lexer.TokenType.EntityFunctionImportCall:
        navigation = ResourcePath.singleNavigation(
          value,
          resource.next,
          resource.value.import.metadata,
        );
      ...
      case Lexer.TokenType.PrimitiveCollectionFunctionImportCall:
        navigation = ResourcePath.collectionPath(
          value,
          resource.next,
          resource.value.import.metadata,
        );
  ...
  export function collectionNavigation(
    ...
    const path = ResourcePath.collectionNavigationPath(value, index, metadataContext);
  ...
  export function collectionNavigationPath(
    ...
    const start = index;
    const token =
      ResourcePath.collectionPath(value, index, metadataContext) ||
    ...
    if (predicate) {
      ...
      const navigation = ResourcePath.singleNavigation(value, index, metadataContext);
      if (navigation) {
  ...
  export function boundOperation(
    ...
    const operation =
      ResourcePath.boundEntityColFuncCall(value, index, isCollection, metadataContext) ||
  ...
  export function boundFunctionCall(
    ...
    const params = ResourcePath.functionParameters(value, index);
    if (!params) return;
    index = params.next;
  ...
  export function boundEntityFuncCall(
    ...
    return ResourcePath.boundFunctionCall(
      value,
      index,
  ...
  export function functionParameter(
    ...
    const token =
      Expressions.parameterAlias(value, index) || PrimitiveLiteral.primitiveLiteral(value, index);
