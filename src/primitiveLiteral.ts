...
export function lineStringData(value:number[], index:number):Lexer.Token {
	return multiGeoLiteralFactory(value, index, '', positionLiteral);
}
export function ringLiteral(value:number[], index:number):Lexer.Token {
	return multiGeoLiteralFactory(value, index, '', positionLiteral);
...
export function polygonLiteral(value:number[], index:number):Lexer.Token {
...
export function collectionLiteral(value:number[], index:number):Lexer.Token {
	return multiGeoLiteralFactory(value, index, 'Collection', geoLiteral);
}
export function lineStringLiteral(value:number[], index:number):Lexer.Token {
...
export function multiLineStringLiteral(value:number[], index:number):Lexer.Token {
	return multiGeoLiteralOptionalFactory(value, index, 'MultiLineString', lineStringData);
}
export function multiPointLiteral(value:number[], index:number):Lexer.Token {
	return multiGeoLiteralOptionalFactory(value, index, 'MultiPoint', pointData);
}
export function multiPolygonLiteral(value:number[], index:number):Lexer.Token {
	return multiGeoLiteralOptionalFactory(value, index, 'MultiPolygon', polygonData);
}
export function multiGeoLiteralFactory(value:number[], index:number, prefix:string, itemLiteral:Function):Lexer.Token {
...
export function multiGeoLiteralOptionalFactory(value:number[], index:number, prefix:string, itemLiteral:Function):Lexer.Token {
	if (!Utils.equals(value, index, prefix + '(')) return;
	var start = index;
	index += prefix.length + 1;
...
export function geoLiteral(value:number[], index:number):Lexer.Token {
...
export function fullLineStringLiteral(value:number[], index:number):Lexer.Token {
	return fullGeoLiteralFactory(value, index, lineStringLiteral);
}
export function fullMultiLineStringLiteral(value:number[], index:number):Lexer.Token {
	return fullGeoLiteralFactory(value, index, multiLineStringLiteral);
}
export function fullMultiPointLiteral(value:number[], index:number):Lexer.Token {
	return fullGeoLiteralFactory(value, index, multiPointLiteral);
}
export function fullMultiPolygonLiteral(value:number[], index:number):Lexer.Token {
	return fullGeoLiteralFactory(value, index, multiPolygonLiteral);
}
export function fullPolygonLiteral(value:number[], index:number):Lexer.Token {
	return fullGeoLiteralFactory(value, index, polygonLiteral);
}
export function fullGeoLiteralFactory(value:number[], index:number, literal:Function){
...
export function geographyLineString(value:number[], index:number):Lexer.Token {
	return geoLiteralFactory(value, index, 'Edm.GeographyLineString', Lexer.geographyPrefix, fullLineStringLiteral);
}
export function geographyMultiLineString(value:number[], index:number):Lexer.Token {
	return geoLiteralFactory(value, index, 'Edm.geographyMultiLineString', Lexer.geographyPrefix, fullMultiLineStringLiteral);
}
export function geographyMultiPoint(value:number[], index:number):Lexer.Token {
