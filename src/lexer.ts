...
export namespace Lexer {
  ...
  export function whitespaceLength(value, index) {
    if (Utils.equals(value, index, '%20') || Utils.equals(value, index, '%09')) return 3;
      ...
      Lexer.SP(value[index]) ||
      Lexer.HTAB(value[index]) ||
      value[index] === 0x20 ||
      value[index] === 0x09
    )
      return 1;
  ...
  export function otherDelims(value: Utils.SourceArray, index: number): number {
    if (value[index] === 0x21 || value[index] === 0x2b) return index + 1;
      ...
      return (
        ...
        Lexer.STAR(value, index) ||
        Lexer.COMMA(value, index) ||
        Lexer.SEMI(value, index)
      );
  }
  ...
  export function subDelims(value: Utils.SourceArray, index: number): number {
    if (value[index] === 0x24 || value[index] === 0x26) return index + 1;
      ...
      return (
        Lexer.SQUOTE(value, index) || Lexer.EQ(value, index) || Lexer.otherDelims(value, index)
      );
  }
  ...
  export function pchar(value: Utils.SourceArray, index: number): number {
    if (Lexer.unreserved(value[index])) return index + 1;
      ...
      return (
        Lexer.subDelims(value, index) ||
        Lexer.COLON(value, index) ||
        Lexer.AT(value, index) ||
        Lexer.pctEncoded(value, index) ||
        index
      );
  }
  ...
  export function base64char(value: number): boolean {
    return Lexer.ALPHA(value) || Lexer.DIGIT(value) || value === 0x2d || value === 0x5f;
  }
  ...
  export function oneToNine(value: number): boolean {
    return value !== 0x30 && Lexer.DIGIT(value);
  }
